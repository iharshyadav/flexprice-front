...
import { InputVariant, NumberFormatOptions } from './types';
import { DEFAULT_FORMAT_OPTIONS, formatAmount, removeFormatting } from './utils';

export { formatAmount, removeFormatting };
export type { InputVariant, NumberFormatOptions };
